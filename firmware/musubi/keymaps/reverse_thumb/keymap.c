...
#define LTMB_L LT(LAYER_FUNCTION, KC_ESC)
#define LTMB_R LT(LAYER_NAVIGATION, KC_BSPC)
#define RTMB_L LT(LAYER_SYMBOLS, KC_SPC)
#define RTMB_R LT(LAYER_NUMERAL, KC_ENT)
